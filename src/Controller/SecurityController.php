...
class SecurityController extends AbstractController
{
    ...
    public function login(ManagerRegistry $doctrine, AuthenticationUtils $authenticationUtils, Request $request): Response // Injection de la dependance authenticationutils
    {
